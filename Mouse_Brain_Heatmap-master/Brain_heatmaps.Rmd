...
setwd("/Users/lee.marshall/Desktop/MBA/Mouse_Brain_Heatmap-master")
set.seed(42)
...
regions=c("AOV","AON","AOB","MOB","FRP","ORB","MO","CP","ACB","RSP",
          "VIS","HPF","CA1","CA2","CA3","DG","LHA","SNr","VTA","AV",
          "VAL","VM","PF","PO","LP","LD","SPFp","VPM","RT","PRNr",
          "PRNc","MDRN", "LRN", "PGRNI", "PARN","SPVC","PAG","MRN","CU","LPO",
          "SS","CBX") 
#Scores that match the above regions 
DSS.m = rep(x = c(0,0.1,0,0.4,0.1,0.3,0.4,1.4,2,0.1,1.3,1.6,0.1,0.2,0.1), 
            times = c(6,3,2,6,1,1,10,2,4,1,1,1,1,1,2))
...
library(grImport)
img = PostScriptTrace("100883867.ps",
                      "100883867.ps.xml")
